...
humandate: "11 - 12 May 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Mik Black", "Murray Cadzow"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
etherpad:    https://pad.carpentries.org/2020-05-11-ttt-online-nz         # optional: URL for the workshop Etherpad if there is one
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event will be emailed to participants.
